...
<%  'This would normaly go in a another page, but for the sake of simplicity and to minimize the number of pages
	...
	Public Function Page_Controls_Init()						
		...
		cbRepeatDirection.Items.Add "Horizontal","1",True
		cbRepeatDirection.Items.Add "Vertical","2",False
		cbRepeatDirection.AutoPostBack = True
		cbRepeatLayout.Items.Add "Table","1",True
		cbRepeatLayout.Items.Add "Flow","2",False
		cbRepeatLayout.AutoPostBack=True
		
		cbRepeatColumns.Items.Add "1","1",False
		cbRepeatColumns.Items.Add "5","5",True
		cbRepeatColumns.Items.Add "8","8",False
		cbRepeatColumns.Items.Add "12","12",False
