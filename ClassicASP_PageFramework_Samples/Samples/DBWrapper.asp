<%
	...
	Public Sub OpenConnection() 		
	    If mobjConnection Is Nothing Then
			...
			'mobjConnection.ConnectionString = "Provider=SQLOLEDB.1;Password=isabella;Persist Security Info=True;User ID=sa;Initial Catalog=MCMS;Data Source=localhost"
			mobjConnection.Open
		End If
	End Sub
